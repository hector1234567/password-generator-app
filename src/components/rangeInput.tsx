  ...
  return (
    <>
      <input
        ...
        className="[&::-webkit-slider-thumb]:hover:bg-grey-950 [&::-moz-range-thumb]:hover:bg-grey-950 mb-8 h-2 w-full cursor-pointer appearance-none rounded-none accent-amber-500 transition-all [&::-moz-range-thumb]:h-[28px] [&::-moz-range-thumb]:w-[28px] [&::-moz-range-thumb]:cursor-pointer [&::-moz-range-thumb]:rounded-full [&::-moz-range-thumb]:border-none [&::-moz-range-thumb]:bg-white [&::-moz-range-thumb]:hover:border-2 [&::-moz-range-thumb]:hover:border-green-200 [&::-webkit-slider-thumb]:h-[28px] [&::-webkit-slider-thumb]:w-[28px] [&::-webkit-slider-thumb]:cursor-pointer [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-white [&::-webkit-slider-thumb]:hover:border-2 [&::-webkit-slider-thumb]:hover:border-green-200"
      />
